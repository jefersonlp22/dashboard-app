...
const FilterMenu = ({closeDrawer, handleAction, clearFilter, children, isEnabled, ...props}) => {
   return (
       <div className="FilterMenu df fdc">
           ...
           <div className="FilterMenu--footer">
                <Button primary type="button" onClick={handleAction} disabled={isEnabled} className="btFullWidth">Aplicar Filtros</Button>
           </div>
       </div>
   )
}
